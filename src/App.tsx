    ...
    return (
      ...
      `}</style>
            ...
            >
                <div className="max-w-[1400px] mx-auto flex items-center justify-between">
                    ...
                    <div className="hidden lg:flex items-center gap-8 xl:gap-12 font-inter text-xs tracking-widest font-medium text-[#1D4E4E] absolute left-1/2 -translate-x-1/2">
                        {['PRACTICE', 'INSTRUCTOR', 'PRENATAL', 'KIDS YOGA', 'WHY US', 'ABOUT', 'REVIEWS'].map((item) => (
                            <a
                                key={item}
            ...
            <main>
                ...
                {/* --- Practice Section --- */}
                <section id="practice" className="py-20 px-6 bg-white reveal-on-scroll">
                ...
                <section id="instructor" className="py-20 px-6 bg-[#1D4E4E] text-[#FAF7F2] relative overflow-hidden reveal-on-scroll">
                    {/* Background Pattern */}
                ...
                {/* --- Prenatal & Postnatal Yoga Section --- */}
                <section id="prenatal" className="py-20 px-6 bg-[#FAF7F2] relative overflow-hidden reveal-on-scroll">
                    <div className="absolute top-[20%] left-[5%] w-[300px] h-[300px] bg-[#A8Caba]/[0.15] rounded-full blur-[80px] pointer-events-none" />
                    <div className="absolute bottom-[20%] right-[10%] w-[350px] h-[350px] bg-[#C5A059]/[0.1] rounded-full blur-[100px] pointer-events-none" />

                    <div className="max-w-[1200px] mx-auto relative z-10">
                        {/* Section Header */}
                        <div className="text-center mb-16">
                            <span className="inline-flex items-center gap-2 text-xs font-bold tracking-[0.2em] text-[#C5A059] uppercase">
                                <Heart size={14} className="text-[#C5A059]" />
                                A Sacred Practice for Mothers
                            </span>
                            ...
                            <p className="text-[#1D4E4E]/70 font-inter mt-4 max-w-2xl mx-auto leading-relaxed">
                                Nurture your body, mind, and spirit through the beautiful journey of motherhood. Our certified trainers bring specialized, safe, and comforting practices directly to your home — adapting completely to your comfort and schedule.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="order-2 lg:order-1">
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: 'Eases pregnancy discomforts, reduces anxiety, and builds physical strength to prepare your body for a smoother labor and delivery.',
                                            color: '#C5A059'
                                        },
                                        {
                                            icon: Heart,
                                            title: 'Postpartum Recovery',
                                            desc: 'Accelerates healing, gradually restores core and pelvic floor strength, and supports emotional well-being after childbirth.',
                                            color: '#A8Caba'
                                        },
                                        {
                                            icon: Sun,
                                            title: 'Safety First',
                                            desc: 'Trimester-appropriate practices guided by certified instructors to honor your changing body and ensure both you and your baby remain safe.',
                                            color: '#1D4E4E'
                                        },
                                        {
                                            icon: Clock,
                                            title: 'At-Home Convenience',
                                            desc: 'No travel stress. Personalized one-on-one sessions in the sanctuary of your home at times that naturally suit your rhythm.',
                                            color: '#25D366'
                                        }
                                    ].map((benefit, idx) => (
                                        <div key={idx} className="group flex gap-4 bg-white rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-300 border border-transparent hover:border-[#C5A059]/20">
                                            <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0 transition-colors duration-300" style={{ backgroundColor: benefit.color === '#25D366' ? '#25D36615' : benefit.color === '#1D4E4E' ? '#1D4E4E15' : benefit.color === '#C5A059' ? '#C5A05915' : '#A8Caba30' }}>
                                ...
                                <button
                                    onClick={handleWhatsAppBooking}
                                    className="w-full flex items-center justify-center gap-2 bg-[#1D4E4E] text-white py-4 rounded-full font-bold text-xs tracking-widest hover:bg-[#C5A059] transition-colors shadow-lg"
                                >
                                    <WhatsAppIcon size={16} />
                                    BOOK MATERNITY YOGA
                                </button>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-4 pt-8">
                                        <div className="rounded-3xl overflow-hidden aspect-[3/4] shadow-lg border-4 border-white">
                                            <img
                                                src="https://images.unsplash.com/photo-1725271765587-43913951f4b7?q=80&w=2000&auto=format&fit=crop"
                                                alt="Prenatal yoga at home"
                                                loading="lazy"
                                                decoding="async"
                                        ...
                                        <div className="rounded-2xl bg-white p-5 text-center shadow-md">
                                            <Flower2 size={28} className="text-[#C5A059] mx-auto mb-2" />
                                            <p className="font-cormorant text-lg font-bold text-[#1D4E4E]">100+ Mothers</p>
                                            <p className="text-xs font-inter text-[#1D4E4E]/90">Nurtured locally</p>
                                        </div>
                                    </div>
                                    <div className="space-y-4">
                                        <div className="rounded-2xl bg-[#E6EFEA] p-5 text-center shadow-md">
                                            <Wind size={28} className="text-[#1D4E4E] mx-auto mb-2" />
                                            <p className="font-cormorant text-lg font-bold text-[#1D4E4E]">All Trimesters</p>
                                            <p className="text-xs font-inter text-[#1D4E4E]/90">Safe & gentle</p>
                                        </div>
                                        <div className="rounded-3xl overflow-hidden aspect-[3/4] shadow-lg border-4 border-white">
                                            <img
                                                src="https://images.unsplash.com/photo-1665708396599-4b8557e57d97?q=80&w=2000&auto=format&fit=crop"
                                                alt="Pregnancy yoga and meditation"
                                                loading="lazy"
                                                decoding="async"
                                                className="w-full h-full object-cover hover:scale-105 transition-transform duration-700"
                                            />
                ...
                {/* --- Kids Yoga Section --- */}
                <section id="kids-yoga" className="py-20 px-6 bg-gradient-to-br from-[#FFF8F0] via-[#FFF5E6] to-[#F0EDE5] relative overflow-hidden reveal-on-scroll">
                ...
                <section id="why-us" className="py-20 px-6 bg-white reveal-on-scroll">
                    <div className="max-w-[1200px] mx-auto">
                ...
                <section id="about" className="py-20 px-6 bg-[#FAF7F2] reveal-on-scroll">
                ...
                <section id="reviews" className="py-20 px-6 bg-white border-t border-gray-100 reveal-on-scroll">
                ...
                <section className="py-20 px-6 bg-[#E6EFEA] relative overflow-hidden reveal-on-scroll">
